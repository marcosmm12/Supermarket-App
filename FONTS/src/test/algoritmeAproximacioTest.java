...
public class algoritmeAproximacioTest {
    private static algoritmeAproximacio a;

    private Map<Pair<Integer, Integer>, Integer> nodos;
    private int numProductos;
    private int costoOptimo;

    public algoritmeAproximacioTest(int[][] matrix, int numProductos, int costoOptimo) {
    ...
    {
        List<Integer> result = a.aplicarAlgoritme(nodos, numProductos);
        ...
        int costoObtenido = a.calcularCostoCiclo(nodos, result);
        assertTrue("El costo debe ser como máximo dos veces el óptimo", costoObtenido <= 2 * costoOptimo);
        //System.out.println(costoObtenido);
    }
